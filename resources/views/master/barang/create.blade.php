...
<div class="bg-white rounded-lg shadow-lg p-6 max-w-2xl mx-auto">
    <h2 class="text-2xl font-bold text-gray-800 mb-6">Formulir Tambah Barang Baru</h2>
            ...
            <div>
                ...
                <select name="id_satuanbarang" id="id_satuanbarang" required
                    ...
                    @foreach($satuans as $satuan)
                        <option value="{{ $satuan->id }}" {{ old('id_satuanbarang') == $satuan->id ? 'selected' : '' }}>{{ $satuan->nama_satuan }}</option>
                    @endforeach
                </select>
