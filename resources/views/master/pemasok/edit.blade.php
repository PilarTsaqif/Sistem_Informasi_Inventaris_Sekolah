...
<div class="bg-white rounded-lg shadow-lg p-6 max-w-lg mx-auto">
    <h2 class="text-2xl font-bold text-gray-800 mb-6">Formulir Edit Pemasok</h2>
    <form action="{{ route('master.pemasok.update', $pemasok) }}" method="POST">
        @csrf
        @method('PUT')
        <div>
            <label for="nama_pemasok" class="block text-sm font-medium text-gray-700">Nama Pemasok <span class="text-red-600">*</span></label>
            <input type="text" name="nama_pemasok" id="nama_pemasok" value="{{ old('nama_pemasok', $pemasok->nama_pemasok) }}" required 
