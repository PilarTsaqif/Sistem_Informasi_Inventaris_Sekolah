...
<div class="bg-white rounded-lg shadow-lg p-6 max-w-lg mx-auto">
    ...
    <form action="{{ route('master.kategori-barang.update', $kategoriBarang) }}" method="POST">
        @csrf
        @method('PUT')
        <div>
            <label for="nama_kategori" class="block text-sm font-medium text-gray-700">Nama Kategori <span class="text-red-600">*</span></label>
            <input type="text" name="nama_kategori" id="nama_kategori" value="{{ old('nama_kategori', $kategoriBarang->nama_kategori) }}" required 
